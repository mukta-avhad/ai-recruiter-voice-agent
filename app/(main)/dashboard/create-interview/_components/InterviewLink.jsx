                   ...
                   <div className='mt-3 flex gap-3 items-center'>
                     ...
                     <div className='flex gap-5'>
                        <h2 className='text-sm text-gray-500 flex gap-1 items-center'> <Clock className='h-4 w-4'/> {formData?.duration} </h2>
                         <h2 className='text-sm text-gray-500 flex gap-1 items-center'> <List className='h-4 w-4'/>  10 questions </h2>
                         {/*} <h2 className='text-sm text-gray-500 flex gap-1 items-center'> <Calendar className='h-4 w-4'/> 30 min {formData?.duration} </h2> */}
                     </div>
            </div>

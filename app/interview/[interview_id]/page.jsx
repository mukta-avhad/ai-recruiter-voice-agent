    ...
    return (
        <div className='px-10 md:px-28 lg:px-48 xl:px-64 mt-10 '>
             <div className='flex flex-col items-center justify-center
              border rounded-lg bg-white  p-7 lg:px-33 xl:px-52 mb-20'>
                <Image src={'/logo.jpeg'} alt='logo' width={200} height={200}
                            ...
                            <h2 className='flex gap-1 items-center text-gray-500 mt-2'> 
                         ...
                         <div className='w-full'>
                          ...
                          <div className='w-full'>
                              ...
                              <Input placeholder='e.g. johnsmith02@email.com' onChange={(event)=>setUserEmail(event.target.value)}/>
                         </div>
